...
public:
    ...
    FileDataOperationManager(std::string path, std::vector<char> filePrefix, std::vector<char> filePosfix, std::string trashPath);
    ...
    {
        return m_DirTrashPath;
    }

    const std::vector<char>& GetFilePrefix() const
    {
        return m_FilePrefix;
    }

    const std::vector<char>& GetFilePostfix() const
    {
