...
{
    return ::GetSerializeSize(tx, SER_NETWORK, BITCOIN_PROTOCOL_VERSION | SERIALIZE_TRANSACTION_NO_WITNESS) * (WITNESS_SCALE_FACTOR -1) + ::GetSerializeSize(tx, SER_NETWORK, BITCOIN_PROTOCOL_VERSION);
}
