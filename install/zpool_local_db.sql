...
CREATE TABLE `mining_workers` (
  ...
  `accept_1m`  decimal(28,8) NOT NULL DEFAULT '0.0',
  `accept_5m`  decimal(28,8) NOT NULL DEFAULT '0.0',
  `accept_15m` decimal(28,8) NOT NULL DEFAULT '0.0',
  `reject_15m` decimal(28,8) NOT NULL DEFAULT '0.0',
  `accept_1h`  decimal(28,8) NOT NULL DEFAULT '0.0',
  `reject_1h`  decimal(28,8) NOT NULL DEFAULT '0.0',
