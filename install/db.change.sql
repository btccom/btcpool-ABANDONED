...
--
-- 2017-09-13
-- set DEFAULT '0' to field `is_orphaned` in table `found_blocks` and `found_aux_blocks`
...
alter table `found_aux_blocks` change `is_orphaned` `is_orphaned` tinyint(4) NOT NULL DEFAULT '0';
