...
cd btcpool/docker/dcrd/v1.4.0-debug

# If your server is in China, please check "Dockerfile" and uncomment some lines.

# build
docker build -t dcrd:1.4.0-debug .
# docker build --no-cache -t dcrd:1.4.0-debug .
...
docker run -it -v /work/dcrd:/root/.dcrd --name dcrd -p 9108:9108 -p 9109:9109 --restart always -d dcrd:1.4.0-debug
