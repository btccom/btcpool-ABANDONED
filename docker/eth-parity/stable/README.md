...
docker stop eth-parity
docker rm eth-parity
docker run -it -v /work/ethereum/eth-parity/:/home/parity/.local/share/io.parity.ethereum/ -p 8545:8545 -p 30303:30303 --name eth-parity --entrypoint=/bin/bash parity/parity:stable
```
...
docker stop etc-parity
docker rm etc-parity
docker run -it -v /work/ethereum/etc-parity/:/home/parity/.local/share/io.parity.ethereum/ -p 8545:8545 -p 30303:30303 --name etc-parity --entrypoint=/bin/bash parity/parity:stable
```
