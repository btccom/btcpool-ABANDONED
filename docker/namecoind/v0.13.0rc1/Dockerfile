...
# download namecoind
RUN mkdir ~/source
RUN cd ~/source && wget https://github.com/namecoin/namecoin-core/archive/nc0.13.0rc1.tar.gz -O nc0.13.0rc1.tar.gz \
  && tar zxf nc0.13.0rc1.tar.gz

# bdb 4.8
RUN cd ~/source/namecoin-core-nc0.13.0rc1 \
