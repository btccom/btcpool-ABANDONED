...
union tellor_hash256 tellor_keccak256(const uint8_t* data, size_t size)
{
    union tellor_hash256 hash;
    keccak(hash.word64s, 256, data, size);
    return hash;
}

union tellor_hash256 tellor_keccak256_32(const uint8_t data[32])
{
    union tellor_hash256 hash;
...
union tellor_hash512 tellor_keccak512(const uint8_t* data, size_t size)
{
    union tellor_hash512 hash;
    keccak(hash.word64s, 512, data, size);
    return hash;
}

union tellor_hash512 tellor_keccak512_64(const uint8_t data[64])
{
    union tellor_hash512 hash;
