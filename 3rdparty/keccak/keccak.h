/* tellor: C/C++ implementation of tellor, the Ethereum Proof of Work algorithm.
 ...
 */
void tellor_keccakf1600(uint64_t state[25]) NOEXCEPT;
 ...
 */
void tellor_keccakf800(uint32_t state[25]) NOEXCEPT;

union tellor_hash256 tellor_keccak256(const uint8_t* data, size_t size) NOEXCEPT;
union tellor_hash256 tellor_keccak256_32(const uint8_t data[32]) NOEXCEPT;
union tellor_hash512 tellor_keccak512(const uint8_t* data, size_t size) NOEXCEPT;
union tellor_hash512 tellor_keccak512_64(const uint8_t data[64]) NOEXCEPT;
