...
TEST(StratumMinerGrin, LocalShareGrin) {
    ...
    StratumTraitsGrin::LocalShareType ls1(0xFFFFFFFFFFFFFFFFULL, 0xFFFFFFFFU, 0xFFFFFFFFU);
    {
        StratumTraitsGrin::LocalShareType ls2(0xFFFFFFFFFFFFFFFEULL, 0xFFFFFFFFU, 0xFFFFFFFFU);
        ASSERT_EQ(ls2 < ls1, true);
    }
    {
        StratumTraitsGrin::LocalShareType ls2(0xFFFFFFFFFFFFFFFFULL, 0xFFFFFFFEU, 0xFFFFFFFFU);
        ASSERT_EQ(ls2 < ls1, true);
    }
    {
        StratumTraitsGrin::LocalShareType ls2(0xFFFFFFFFFFFFFFFFULL, 0xFFFFFFFFU, 0xFFFFFFFEU);
        ASSERT_EQ(ls2 < ls1, true);
    }

    {
        StratumTraitsGrin::LocalShareType ls2(0xFFFFFFFFFFFFFFFFULL, 0xFFFFFFFFU, 0xFFFFFFFFU);
